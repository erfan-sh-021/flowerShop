...
export default function CartDrawer({
  ...
  const handleCheckout = () => {
    onClose(); // اول منو رو ببند
    setTimeout(() => {
      router.push("/checkout"); // بعد از بسته شدن منو برو صفحه checkout
    }, 300); // صبر کن تا انیمیشن تموم شه
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end font-sans">
      ...
      {/* پنل سبد خرید */}
      <div
        className={`relative w-80 bg-white h-full shadow-xl p-4 flex flex-col 
                  ...
                  <div className="flex items-center gap-2 mt-1 ml-4 justify-between">
                    <div className="gap-2 flex items-center">
                      <button
                        ...
                        className="px-2 bg-gray-200 rounded hover:bg-green"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="px-1.5 bg-gray-200 rounded hover:bg-green"
                      >
                        +
                      </button>
                    </div>
        ...
        {items.length > 0 && (
          <div className="mt-4">
            ...
            <button
              ...
              className="bg-green text-white text-center py-2 px-14 rounded block hover:bg-darkgreen transition  mx-auto"
            >
              تکمیل خرید
            </button>
          </div>
